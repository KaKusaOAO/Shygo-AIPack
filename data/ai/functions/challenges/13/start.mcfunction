...
# C
tellraw @a {"text":"A: ","extra":[{"translate":"entity.minecraft.iron_golem"}]}
tellraw @a {"text":"B: ","extra":[{"translate":"entity.minecraft.enderman"}]}
tellraw @a {"text":"C: ","extra":[{"translate":"entity.minecraft.zombie"}]}
tellraw @a {"text":"D: ","extra":[{"translate":"entity.minecraft.villager"}]}